...
export default class ToneJsHandler {
    ...
    step() {
        ...
        // Pulse 1
        if (this.s.pulse1.enabled  && this.s.pulse1.enabled && this.s.pulse1.frequencyLower !== 0) {
        ...
        // Pulse 2
        if (this.s.pulse2.enabled && this.s.pulse2.enabled && this.s.pulse2.frequencyLower !== 0) {
        ...
        // Wave
        if (this.s.wave.enabled && this.s.wave.enabled && this.s.wave.frequencyLower !== 0) {
